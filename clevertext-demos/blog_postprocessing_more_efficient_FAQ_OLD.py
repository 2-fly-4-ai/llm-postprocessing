...
####################################### GRABS THE HEADING ################################################################
    ...
    header = pre2.replace("</h2>","</h2>$$$").split("$$$")[0]
    header = header.replace("<h3>","<h2>").replace("</h3>","</h2>")
    header = header.split(" ")
...
test1.to_csv(r"Modern-FAQ-post.csv")
...
test2.to_csv(f"leftovers_Modern-FAQ-post.csv")